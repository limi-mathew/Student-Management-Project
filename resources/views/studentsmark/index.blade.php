          ...
          <div class="content-wrapper">
            ...
            <div class="row">             
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                 <div class="container">
                  <h2 style="margin-top: 40px;">Student Marks</h2>  
                   @if(session()->has('message.level'))
                  <div class="alert alert-{{ session('message.level') }}"> 
                  {!! session('message.content') !!}
                  </div>
                  @endif 
                  <a href="studentmarks/create" ><button class="btn btn-success" style="margin-left: 800px;">Add Student Marks</button></a> 
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{date('F jS,Y h:i:s A', strtotime($result->created_at))}}</td>
                       <td> <a href="/studentmarks/{{$result->id}}/edit"><button class="btn btn-success">edit</button></a></td>
                        <form action="/studentmarks/{{$result->id}}" method="post">
                        @csrf
                        @method("DELETE")
                     <td><button onclick="return confirm('Are you sure you want to delete?');" class="btn btn-danger">delete</button></td>
                 </form>
                      </tr>
                      @endforeach
                    </tbody>
                  ...
                  @else
                   <div class="alert alert">No result Found
                  </div>
                  @endif
                </div>
                </div>
