              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="/studentmarks" method="post"  class="forms-sample">
                     @csrf
                      ...
                      <div class="form-group">
                       ...
                       <select class="form-control" name="term" id="exampleSelectGender">
                          <option value="">Select</option>
                    ...
                    <tbody>
                      <tr>
                        <td>Maths</td>
                       <td><input type="text" class="form-control marks"  name="maths">
                         @error("maths")
                      ...
                      <tr>
                        <td>Science</td>
                       <td><input type="text"  class="form-control marks"  name="science">
                        @error("science")
                      ...
                      <tr>
                        <td>History</td>
                       <td><input type="text" class="form-control marks"  name="history">
                        @error("history")
                       ...
                       <td>
                        <input type="text"  class="form-control" name="total_marks" id="totalvalue"/>
                        <!--input type="text" class="form-control" id="total_marks"  name="total_marks"--></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
