              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                 <div class="container">
                  ...
                  @endif 
                  <a href="students/create" ><button class="btn btn-success" style="margin-left: 800px;">Add Student</button></a>   
                   @if($count > 0)          
                  <table class="table">
                      <tr>
                        <th>ID</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       <td> <a href="/students/{{$student->id}}/edit"><button class="btn btn-success">edit</button></a></td>
